      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkedIndex==index|item.isDefault}" @click="checkedIndex=index;selectAddressId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expand" v-bind:class="{'open':this.limit>3}">
                more
                <i class="i-up-down">
          ...
          <div class="next-btn-wrap">
            ...
            <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfirm',query:{addressId:selectAddressId}}">订单确认</router-link>
          </div>
        </div>
      </div>
    </div>
