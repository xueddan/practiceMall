<template>
  <header class="header">
          ...
          <div class="confirm-tips">
            ...
            <ul>
              ...
              <li class="regi_form_input">
                ...
                <input type="text" tabindex="2" name="password" class="regi_login_input" v-model="userPwd" @keyup.enter="login"/>
              </li>
            </ul>
          </div>
    ...
    <div class="md-overlay" v-if="loginModalFlag" @click="loginModalFlag=false" v-bind:class="{'md-show':loginModalFlag}"></div>
  </header>
